...
\newcommand{\writeme}[1]{{\color{gray} #1}}
...
\newif\ifdesperateforspace\desperateforspacefalse
...
\newcommand{\SUBSECTION}[4]{%
  \subsection{#1}
  \label{#2}
  \immediate\write\workplanfile{\string\task{#1}{#2}{#3}{#4}}
}
...
\newcommand{\ganttsection}[1]{
  \\ \ganttbar[bar/.append style={draw=white}] {\bf #1}{2}{3}}
\newcommand{\task}[4]{
...
\title{CCF Core: Medium: Property-Based Testing in Practice}
