...
\newcommand{\benjamincolor}{nord-frost4}
\newcommand{\bothcolor}{nord-purple}
\newcommand{\andrewcolor}{nord-red}
\newcommand{\othercolor}{black}
...
\newcommand{\SUBSECTION}[6]{%
  ...
  \immediate\write\workplanfile{%
    \string\tasksection{#1}{#2}{#3}{#4}{\FOO}}%
}
\newcommand{\tasksection}[5]{
