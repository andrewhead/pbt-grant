...
\newcommand{\publicationtargets}[1]{\smallskip {\em Publication targets:} #1.}
...
\todo{
  \begin{enumerate}
  \item Carefully read the PAAPG and check rules (Benjamin and Andrew)
  \item Check LLM-ification (Benjamin)
  \item Recheck supplemental docs (Benjamin)
  \item Re-read
  \item Spellcheck
  \item Carve up into separate docs for uploading (Benjamin)
  \end{enumerate}
}
