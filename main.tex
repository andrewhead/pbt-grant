...
\newcommand{\GhostChat}{{\sc Ghostwriter++}}
\newcommand{\Mica}{{\sc Mica}}
...
\todo{
  \begin{enumerate}
    ...
    the grant application.  (Maybe it's enough now?)
    ...
    behavior [everybody] [Andrew added draft paragraphs to intro. We
    should revise it, and then propagate our emphasis of
    transformational aspects to the appropriate section headers.]
