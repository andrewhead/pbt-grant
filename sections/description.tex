...
encouraging, we have just scratched the surface of their potential uses.

\hg{
  \begin{itemize}
    \item Improving algorithms for tuning
    \item Improving algorithms for shrinking
    \item Integrating fuzzing
  \end{itemize}
}
...
\hg{
  \begin{itemize}
    \item Reflectives outside of Haskell
    \item Automation of some workflows
    \item Evaluating usability
  \end{itemize}
}
