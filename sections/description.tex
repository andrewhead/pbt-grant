...
Our research agenda is motivated by a deep formative study of the usability
challenges in PBT tools that must be addressed to boost adoption
The study data consisted of thirty semi-structured interviews
with (1) developers who use PBT and (2) maintainers of PBT tools.
exploring the use of PBT in software practice.
The study has recently been accepted to ICSE's main technical track for
appearance in 2024~\cite{ref:goldstein2024property}.
...
Our industrial partner in this study was Jane Street Capital.
...
of the \iflater\bcp{un-capitalize here and below}\fi\gentheme{Derived
  Generators} that can be automatically
...
Testing}{sec:model-based}{4}{4}{HCI Practice}{PhD 3}{PhD 4}{Pierce}
%
...
Logs}{sec:ltl-logs}{4}{4}{HCI Practice}{PhD 3}{PhD 4}{Pierce}
%
...
Ghostwriter++}{sec:ghostwriter}{4}{4}{HCI Practice}{PhD 3}{PhD 4}{Head}
%
High-leverage PBT scenarios provide a sort of recipe that developers
can use to decide when and
and how to apply PBT, ensuring that they can get the most out of it.  But it is
...
Our re-imagining of Ghostwriter, {\em Ghostwriter++} will be a platform for all
