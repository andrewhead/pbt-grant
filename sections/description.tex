...
students help bootstrap adoption of the same ideas in industry.  PBT
would be a good fit for a number of standard CS courses---compilers,
functional programming, and even early introduction courses. We believe the
best place to begin introducing PBT methodology is in a beginner-level data structures course.
%
Teaching PBT alongside data structures has good
precedent~\cite{wrenn2021using, nelson2021automated}\bcp{what are we
  going to do that's different from what they did?}\amh{+1} and is natural for a number
