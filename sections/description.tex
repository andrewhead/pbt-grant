...
the email thread from rjmh to complete the reference} estimated that the total cost of software errors is almost
...
\hg{Putting this section on my stack for today. It needs to get reordered and
polished with new motivation}
%
...
developers write programs like this\bcplater{Did anyone really guess
  100\%??}\hg{Yep! Someone said ``everyone.''}, where properties are easy to find and
...
moving the specification section to after generation?}
\hg{We should reorder this section, now that we've done that, right?}\fi
