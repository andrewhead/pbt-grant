...
The study format is semi-structured interviews exploring
...
of the project, see \sectionref{sec:foundation} below.  \bcp{Is it
  actually useful to split this discussion between here and
