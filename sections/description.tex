...
engineering, and education activities can be grouped into six main themes:
...
% \end{itemize}
\end{enumerate}
The rest of the Project Description outlines our plans in each of
these areas in turn and concludes with a discussion of the broader
impacts of the proposed work (\sectionref{sec:broader-impacts}) and a
summary of our prior NSF-supported work.
...
\bcp{Talk about the orientation section, }
...
across a wide range of industrial settings.  \bcp{Needs a rewrite for
  the new structure.}

\todo{Somewhere $\leq$ here we need a paragraph talking about how the
  whole project is organized, with pointers to the collaboration
  appendix and a sketch of what's found there.}
