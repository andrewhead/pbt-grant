...
Specificallty, we describe plans to improve PBT's applicability to
...
\lstinline{Inner}, for example:\bcp{I find 1 and 2 a bit unintuitive.}
\begin{lstlisting}
...
compile LTL formulae to properties over log traces\proposecut{ that respect the
...
advanced undergraudate and Master's students.
...
distrubionts, will require tight coordination between the PL and HCI student.
