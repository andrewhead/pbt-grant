...
\SIMPLESECTION{Motivation: A Study of Contemporary Mature PBT Practice}{sec:motivation}
...
In each of these projects, we will follow an
...
The activities described in the previous sections focus on
...
not enough to reach the broad impact we seek. Our agenda
also includes plans for increasing the {\em diffusion} of PBT with both
