...
projects:
\begin{itemize}[noitemsep]
  \item {\bf PBT interaction models}~\sectionref{sec:understanding}: Helping PhD
  1 to build and maintain a minimal PBT framework for use in comparison studies
  and as a model for future PBT frameworks.
  \item {\bf Theory of reflective generators}~\sectionref{sec:reflective}:
  ...
  \item {\bf Mixed-initiative property
  specification}~\sectionref{sec:interactive}, {\bf Counterexamples as
  regression tests}~\sectionref{sec:counter}:
  Assisting PhD
