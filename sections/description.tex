...
\underconstruction{Explain how we are going to measure success:
  \begin{enumerate}
  \item Many of our individual tasks include user surveys to evaluate
  their results.
  \item We will be producing open-source software, so we can measure
  success by number of downloads.
