...
unit-testing frameworks call each unit test a test case.}\bcp{But
that's exactly what we're talking about, right?  A generator generates
many test cases, whereas a unit test just exercises one.}
%
...
Two PIs is on the small side for a Large NSF proposal; we feel this
is the right size for this project, for two reasons. First, the PIs
