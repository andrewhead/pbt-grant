...
\begin{ganttchart}[
  ...
  \gantttitle{Year 3}{1}
  \gantttitle{Year 4}{1} \\
  \ganttbar[bar/.append style={draw=white}] {Foundation}{2}{3} \\
  \ganttbar{\small Surveys to Generalize Findings (\sectionref{sec:survey})}{2}{3} \\
  \ganttbar{Specification}{2}{3} \\
  \ganttbar{Generation}{5}{5} \\
  \ganttbar{Validation}{5}{5} \\
  \ganttbar{Education}{5}{5}
\end{ganttchart}
