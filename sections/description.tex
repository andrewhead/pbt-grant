...
published widely on PL topics including PBT.  \todo{John: So, the
  argument you give for combining PBT and HCI below goes part of the
  way there. But can’t you point to work you have done *already*, that
  illustrates the benefits? You did the Jane St study *because* you
  were collaborating, right? I think you need to highlight that the
  combination is already yielding results *in the first section*.}
...
\todo{Why HCI + PL...
  \begin{itemize}
  \item The HCI area has developed a deep foundation of theory and methodological practice for investigating and understanding usability of systems in a rigorous and objective way.
\item
This foundation informs the current project in three crucial ways:
\begin{itemize}
\item
To give us a clearer understanding of where the adoption challenges are. (As evidenced by the Jane Street study.)
\item To give us access to decades of understanding of best practices in the design of tools, user interfaces, and programming environments
\begin{itemize}
\item
...
We propose an interdisciplinary program of research and engineering on
...
\end{lstlisting}
\rjmhlater{The example property you give looks like a type check: given a BST as
...
%
The cornerstone of our efforts to develop a strong foundation for improved PBT
is to develop a theory of property-based testing.  Theories of programming have
long served a critical role in human-centered software engineering research.
Theories provide rich and memorable descriptions of programming processes.
Furthermore, they describe constructs and mechanisms in the programming process
in a way that clarifies opportunities for tooling and training to be improved.
...
within the code, and implies why programmers sometimes fail in this task. The
theory has motivated a variety of innovative tools that demonstrably improve the
programming experience (e.g.,~\cite{ref:henley2014patchworks}).  Other theories
that have inspired advances in the development of programming tools include
Blackwell's Attention-Investment model~\cite{ref:blackwell2002first} and Ko and
...
Recognizing the power of theory, we will develop a theory of property-based
testing as a cornerstone for our research. The initial theory will be developed
from the framework we arrived at from the Jane Street study. The theory
will be validated and refined by conducting contextual inquiries~\cite[Ch.
3]{ref:holtzblatt1997contextual}with programmers. We will develop a provisional
theory in the first two years.  This theory will help us refine our ideas for
tools, and provide a foundation for contextualizing the questionnaires and
observations described in the next sections. Our evaluation of the tools in this
project provide us with additional evidence to refine the theory, based on
whether those evaluations refute or support hypotheses that arise from the
theory.

Here we briefly sketch out a preliminary theory that follows from the Jane
Street study. While the theory we develop may look quite different from this, we
describe it here to demonstrate the feasibility of doing so, and the predictive
potential of such a theory. We call this the \emph{hill-climbing} theory.
Namely, PBT takes place following a hill-climbing process. A property-based test
...
they feel they cannot make progress. As such, for a programmer to develop a
...
Namely, tools should make it possible to ``cover a lot of ground,'' i.e., test a
...
hypotheses.} A preliminary version of this theory will be developed in the first
