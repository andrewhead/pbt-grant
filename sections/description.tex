...
\tyche{} will be developed as a Visual Studio Code extension, taking
advantage of VSCode's status as the most widely used editor according
to a 2022 survey~\cite{noauthor_stack_nodate} and its support for
every language with mature PBT tooling.
