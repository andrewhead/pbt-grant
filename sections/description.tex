...
the trace is responsible for failure…}
...
and debugging processes---all integrated into a Visual Studio Code, a popular
...
detail...}
\discuss{Zac says one way to help OSS is to provide support in writing grant
applications to companies for funding... Is that an appropriate thing to
allocate our time to? Seems a bit silly to allocate NSF money to ask for
industry money, but maybe that does make sense...}
