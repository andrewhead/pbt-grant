...
\ifnext\todo{Improve this}\fi
Our research agenda is a comprehensive, interdisciplinary research and
engineering program on
{property-based testing}, bringing to bear the combined power of PL and HCI to
accelerate \iflater\hg{bigger word?: finalize? complete?}\fi PBT's
...
interdisciplinary effort will require four PhD students: one with background in
HCI, one in PL, and two with a balance of experience in both areas. The
full work plan can be found in the Coordination and Management
supplement, but at a high
...
by a full-time research engineer, who will focus on transferring the
PhD students
...
\ifnext\todo{Write an introduction.}\fi
...
\forreaders{This section will open with a paragraph about tech
  transfer.  This and education (in the broad sense---developers and
  students) are equal parts of our broad impact story.}
