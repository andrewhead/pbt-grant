...
undergraduate\bcp{and masters?!} computer science curriculum centered around
...
to the diffusion area?  Or is this fine this way?}\hg{I think fine? But I'm not
    totally sure} \amh{I think it is fine too, given that I think our strongest
    efforts to do education fall in the diffusion category (at least the way the
    proposal currently reads)}\fi
% \end{enumerate*}
% \end{itemize}
\end{enumerate}
%
...
\bcp{How about
  \begin{itemize}
  \item {\em Publication target:} International Conference on Software Engineering (ICSE).
  \end{itemize}
?  Or, if we need to save space, we could put this in a final column in the
second figure in the Management and Coordination section.
} \amh{lgtm!}
...
%
Our past work on reflective generators is promising, but
...
Reflective generators offers a powerful foundation enabling a range of
more practical innovations.  We discuss these in the remainder of
\sectionref{sec:gen}.
...
inputs that have no hope of exercising the interesting\amh{Elena comment: ``wish
there was a more descriptive word'' (than ``interesting''} parts of the
...
\begin{wrapfigure}{r}{0.58\textwidth}
  ...
  would evalate generator source code live (1), yielding summary statistics, (2)
  ...
  filters used in the visualizations. \amh{I added this caption back because we
  don't refer to the numbers anywhere, and I personally like captions that make
  very explicit what you should see in the figure.}
...
advocate for that perhaps instead.}
...
\begin{itemize}[noitemsep]
  \item \sectionref{sec:frameworks}: Helping PhD 1 to build and maintain a minimal PBT
    ...
    reminding myself of 3.2, I didn't realize this would be necessary.}
...
\todo{What about masters students???  Arguably even better opportunity
  for impact!} \amh{I think that's a good idea +1}
\todo{Transition}
%
