...
The project will be carried out by two PhD students (and a number of
undergraduate or masters students) over the course of four years. The work is
split roughly into two thrusts, one focused on PL techniques (advised by PI
Pierce) and the other on
HCI (advised by PI Head), but all projects will include ideas from both areas.

The PL thrust, led by PhD candidate Harrison Goldstein, will take place from
years 1--3. Harrison will start by finishing his work on reflective generators
and working {\em When to Specify It!}; later on, he will work on reflective
shrinkers and fuzzers, collaborate with another PhD student on tools for tuning
data distributions, and advise undergraduates and masters students on languages
for writing properties over logs and on automation for testing ML modules.
Harrison has a proven track record of advising and co-advising junior
students~\cite{pytestmutagen}.

The HCI thrust will be the responsibility of a new PhD student, hired between
years 1 and 2; the work will continue through year 4. This work will include
formative HCI research like surveys to generalize our motivating study and
observations of PBT in practice, but also human-centered design projects
including tools to validate data distributions, interactive shrinking and
debugging, and interactive property specification. The second student will also
co-advise an undergraduate or masters project centered around turning
counterexamples into regression tests.

The work on implementing an undergraduate curriculum in PBT will be done in
collaboration with all parties, and will evolve over the course of the four year
project.
...
readily available to every industrial developer.

Specific pedagogical threads within the project are described
in~\sectionref{sec:ed}. Beyond these, the majority of the requested
funding will support graduate students.  We also plan to work with
undergraduate students during this project; they, too will benefit
from the research experience. Each graduate student will have
leadership responsibility for multiple facets of the project,
including co-supervising interested undergraduate researchers.
