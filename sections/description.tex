...
\forreaders{Please take an especially critical look at the
  Coordination and Management appendixappendix and at what we say
...
testing environments---in particular, the processes they use
...
\proposecut{algorithms and} interactive tools
...
A second, more speculative, survey later in the project will investigate
...
useful.
Particular attention will be given to those whose work requires
writing validation code and public APIs with some definition of types\bcplater{Huh?}. We
