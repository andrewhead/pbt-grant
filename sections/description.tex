...
their success. PL approaches will be used to develop powerful
...
process, as well as to formally validate these tools. \bcp{That
  ...
  project's success.  We should say why we need four whole PhD
  students---why can't this agenda be accomplished with fewer.}

\forreaders{Please tell us whether you feel convinced, at this point,
  that we have articulated a ``grand challenge'' and an agenda to
  address it.  }

\medksip

The rest of the Project Description develops this research and
...
\todo{A one-paragraph summary of the Coordination and Management
  ...
  that appendix.\forreaders{Please take an especially critical look at
  that appendix and at what we say about coordination and management
  here in the main project description.  NSF cares a lot about this!}}
...
\subsectionstar{Usability Challenges} The final result of
...
\evaltheme{\normalfont \bf validation}\bcp{Need to figure out how to
  split this into interaction and diffusion... if the latter is too
  hard to motivate from the Jane Street study, we can just
  acknowledge this.}---the processes developers use
...
\bcp{Needs a rewrite for the new structure...}%
%
