...
other design document, because provides a clear connection between the
...
still not that convinced by the examples...}\hg{Any idea why you're not
convinced? Unclear whether I'm just wrong
...
\paragraph*{Mentoring and Diversity}
%
...
<<<<<<< HEAD
groups in computing. I wonder if there is a more humble way of
phrasing this}\bcp{Maybe just delete that point?}---PI Pierce has one
female Ph.D.{} student (who may, indeed, be interested in this
=======
groups in computing. I wonder if there is a more humble way of phrasing
this}\hg{+1. Plus ``relatively'' diverse is already pretty lackluster. Does Penn
have any programs in place to increase representation that we can cite?}---PI Pierce has one
female Ph.D.{} student \hg{While we're at it, I still don't like this framing. Feels too much
like we're just pointing out the token woman in our group}(who may, indeed, be interested in this
>>>>>>> 2271a0120adbcedb91e9b3871550d2fc4e70a571
...
%
\amh{I made changes to this to bring it more in line with my expectations of
what we could deliver. This paragraph could use feedback.}
