...
\discuss{Every section (including the introduction, broader impacts,
  and coordination!) needs to better address how we will measure
  success...}
...
%
A detailed sketch of responsibilities and timeline can be found in the Coordination and Management
supplement, but at a high
level: one PhD student will build on our existing user studies to
develop a clear foundational understanding of
PBT from the perspective of usability and human factors, two students
will develop ``back end'' technologies to support more usable
...
PhD students'
ideas into an industrial context, improving and supporting
...
Success in this project will largely be measured as we go. One major benefit of
...
be measured by their ability to support the user-facing tools. However, we would
also like to verify that a usable ecosystem for PBT actually drives increased
adoption. For this we reach for an admittedly arbitrary but useful metric:
downloads of our \tyche{} IDE. We will list the IDE on the Visual Studio Code
extension marketplace, with a goal of reaching 60,000 downloads. At the time of
writing, this would put \tyche{} in the top 10 extensions tagged ``Testing''
that are not either full language servers or large language model
interfaces~\cite{noauthor_testing_nodate}, which is a lofty but achievable
goal.

\underconstruction{Explain how we are going to measure success:
  \begin{enumerate}
  \item What about metrics for the education parts?
  \item We discuss this in more detail in the Coordination and
  Management supplement.  (Harry: This is where most of the story goes.)
  \end{enumerate}
}
...
laying out their basic theory~\cite{Frohlich2022}. Some significant details of
...
\bcp{The relation between what's done and what's not done is muddy.  I
think we should just go ahead and say we plan to submit a paper fairly
soon, talk about what will be in the paper, and talk about what
...
\underconstruction{We've recently
  moved some sections around -- this summary needs updating. }%
...
\noindent{\bf Impact on industry.} \underconstruction{This section
  will open with a paragraph about tech transfer.  This and education
  (in the broad sense---developers and students) are equal parts of
  our broad impact story.} \smallskip
