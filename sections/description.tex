...
how to help people know {\em when} they are actually in such a situation.
A preliminary study that we ran before the one reported in
\sectionref{sec:motivation}~\cite{goldstein_problems_2022} suggests that
testers---beginner and experienced alike---may\amh{sometimes? may sounds like
they might not} face a kind of writer's block
...
sections~\cite{ref:dohmke2022github}, and the GPT line of tools
(e.g.,~\cite{tool:chatgpt,ref:openai2023gpt4}), which in
...
to hallucination~\cite{ji2023survey}; it is not a good idea
...
The envisioned programming assistant\amh{feels a bit clunky of a transition,
return her if time.}, dubbed {\em \GhostChat}, would wrap existing property generation
...
an action button to ``Look for Automations\amh{is this the right phrase?}.'' The programming assistant will
