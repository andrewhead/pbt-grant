...
This project will be a model for how to get from an ``obviously valuable''
theoretical idea to a vibrant, usability-focused software ecosystem.
Our comprehensive, interdisciplinary research and engineering
program on
{property-based testing}, will bring to bear the combined power of PL and HCI to
accelerate \iflater\hg{bigger word?: finalize? complete?}\fi PBT's transition into practice. The project's research,
...
process\proposecut{, as well as to formally validate these tools}. \ifnext\bcp{That
  ...
  project's success.}\fi
The scale of this project is essential to its success. Accomplishing this
interdisciplinary effort will require four PhD students: one expert in
HCI, one expert in PL, and two with a balance of experience in both areas. The
full work plan can be found in Appendix~\ref{appendix:coord}, but at a high
level: one PhD student will build foundational knowledge of usability aspects of
PBT, two students will develop powerful technologies that support more usable
and useful workflows, and the final student will leverage those technological
advances to build a user-focused IDE for PBT. These students will be supported
by a full-time research engineer who will focus on transferring the PhD students
ideas into an industrial context. This will involve improving and supporting
open-source PBT projects with theoretically-informed ideas. None of these
projects could be done on its own: each feeds into and informs the next,
ultimately amplifying PBT and improving the overall quality of software.
...
The rest of this Project Description develops our research and
...
Finally, our experience with these studies and with our prior research suggests
that significant engineering and pedagogical effort will amplify
...
\edutheme{Classroom Education}. Finally, the existing tools for PBT are
inconsistent and under-maintained; if PBT tools are to become mainstream, we
must provide \edutheme{Support and Guidance for Open-Source
  Communities}\ifnext\bcp{Don't like this title}\fi{} that will help our
...
\todo{Also mention explaining properties}
...
\discuss{Needs a good paragraph about tech transfer.}
