...
one conference publication on the industry study mentioned above~\cite{ref:goldstein2024property},
two workshop
...
generators.
\amh{Can we lead in with what we want to change about working with generators
before getting to specifics? This would help us avoid looking like we're
prematurely converging on reflective generators.}\bcp{@Andrew: How's that?} \amh{Marvelous!}
...
\SUBSECTION{Reflective Generators for the People}{sec:reflectivepeople}{2}{2}{PBT
  Theory}{PhD 2}{Engineer}{Pierce}
%
\amh{This section should state more prominently: we will build reflective
generators into widely-used PBT frameworks.}\bcp{Yes.}
We would like reflective generators to be incorporated in
real PBT frameworks.\amh{Would be more powerful if we can say that developers
would benefit from having reflective generators in their PBT frameworks.}\bcp{Yes.}
%
