...
\begin{wrapfigure}{r}{.5\textwidth}
  \centering
  \vspace*{-2ex}
  \includegraphics[width=.5\textwidth]{assets/overview.pdf}
...
Present-day software developers often face code
that they do not fully understand. Modern applications are assembled
from complex trees of dependencies \bcp{my metaphor checker breaks on
  that} that are too deep to hold
...
\SUBSECTION{Beyond research software}{sec:engineersupport}{3}{5}{Tech
  Transfer}{???}{}{Pierce}
\bcp{Cut to almost nothing (not even a separate subsection)}
%
