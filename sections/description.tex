...
\SECTION{HCI}{More HCI stuff}{sec:morehci}

\bcp{Hopefully these can be integrated into other sections / themes?}

\SUBSECTION{A Cognitive Theory of PBT}{sec:cogtheory}{3}{5}{Andrew}

\SUBSECTION{Rethinking generator languages}{sec:genlang}{2}{4}{Both}

\SUBSECTION{Aids for understanding property specifications}{sec:understanding}{2}{5}{Both}

\SUBSECTION{Dashboards for tracking testing}{sec:dashboards}{2}{3}{Andrew}

\SECTION{Integration}{Advancing Open Source PBT Tooling}{sec:platform}
...
\bcp{If we're going to keep this as a top-level theme, we'll need to
  ...
  of the specific items will fit just fine into the sections we've
  got.  But I wonder whether a top level ``Integration'' theme might
  be helpful for the story.}

\SUBSECTION{Benchmarking Generators}{sec:benchmarks}{1}{2}{Benjamin}

\SUBSECTION{Reference Implementations of Key Algorithms}{sec:refkey}{3}{4}{Both}

\SUBSECTION{Bringing Reflective Technology to Python}{sec:reflpython}{2}{3}{Benjamin}

\SUBSECTION{IDE Integrations}{sec:ide}{3}{5}{Andrew}

\SUBSECTION{Extensible Tools}{sec:extensibility}{3}{5}{Andrew}
