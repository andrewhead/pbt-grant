...
As discussed in the motivation section, one common problem raised by Jane Street
...
For example, on Jane Street developer (\participant{7}) described their experience testing a
