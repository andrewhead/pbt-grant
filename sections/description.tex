...
(including, often, property-based tests), has 9.6K stars~\cn{}---i.e., Python's
...
Hypothesis users is only 4\% of total Python developers; the Hypothesis
developers estimate that PBT could reach up to 25\%
and there is also significant opportunity to increase use by existing
users.
\hg{Changed this based on Zac's comments. Thoughts?}
And the list of
...
accessibility in their languages~\cn{}.
%\cite{PLIERS,Krishnamiurthi.LTL}
...
threads within the project are described in~\sectionref{sec:diffusion}, though
many tasks may ultimately influence educational material design.
