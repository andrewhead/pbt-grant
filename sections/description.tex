...
\TASK{Validation survey}{1}{1}{Who?} The main survey we will conduct
will check that
...
\TASK{Impact survey}{2}{2}{Who?} A more speculative survey we hope to
...
\SECTION{HCI}{More HCI initiatives that Andrew hasn't sorted into the right
place yet}{sec:morehci}

\bcp{Hopefully these can be integrated into other sections / themes?}

Subsections:

\textbf{Towards a theory of property conceptualization and testing}

\textbf{Designing generator languages}

\textbf{Aids for understanding property specifications}

\textbf{Dashboards for tracking test success}

\SECTION{Diffusion}{Advancing Open Source PBT Tooling}{sec:platform}

\bcp{If we're going to keep this as a top-level theme (which I kind
  of like), we'll need to integrate it into the motivation early on
  (i.e., give it a color, talk about how the Jane Street study shows
  we need it, ...)}

Subsections:

\textbf{Benchmarks for PBT}

\textbf{Reference implementations of key algorithms}

\textbf{Bringing reflective technology to Python}

\textbf{Development of IDE integrations}

\textbf{Building hooks into tools for extension and research experimentation}
