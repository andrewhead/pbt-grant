...
We plan to develop innovative trace divergence views that, specifically: (1) 
point programmers to control decisions that vary between a failure-inducing 
...
diverging traces. Such innovations in debugging, we believe, are necessary to 
provide general-purpose support to using trace divergences to debug.
...
literature~\cite{ref:head2018interactive,ref:barik2016quick,murphy2008refactoring,ref:lee2013draganddrop}.
