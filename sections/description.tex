...
\subsectionstar{Motivations from a Formative Study of PBT in Industry
...
A first set of
themes revolves around {\bf specifications} (i.e., properties).
...
Further themes from the interview study concerned the {\bf validation} of
