...
improve both the {\em visibility} and the {\em controllability} of
generators.\amh{Do we actually improve visibility in Section 4?}
...
implemented\amh{in the prior work?}
...
in the existing PBT literature use small case studies,
