...
\hg{Then why are we asking for \$600k+? :-)}
...
applicability, but (a) they sometimes struggle to identify and
articulate properties suitable for testing, \hg{This one feels less true after
talking to JS folks. The property issues at JS are more about identifying
situations where PBT is valuable than they are about articulating properties}
...
newcomers to PBT.  \bcp{All that needs tuning.}
%
