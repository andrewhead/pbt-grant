...
\begin{wrapfigure}{r}{0.6\textwidth}
  ...
  \caption{A mockup of a tool for evaluating input data distributions.
  (1) A developer can invoke the novel tool via controls that appear directly
  next to their property in the editor. They are aided in evaluating the
  input data distribution with (2) Aggregate statistics describing the generated values. (3)
  Sensible aggregate visualizations chosen to match common data features. (4) Example values,
  rendered as strings or DOT graphs. The developer can define additional
...
informative views of input data distributions.
The tools will address the challenges with
...
generated inputs. \amh{Continue the rewrite from here, integrating additional
references.}
