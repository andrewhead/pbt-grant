...
A second survey will focus specifically on characterizing barriers to adoption among current
non-users of PBT. For this survey, we will sample from the
channels as above (software organizations we have a relationship, social media),
but more broadly, including developers who do not use PBT as part of their
practice. We will ask respondents about their current testing practices, in
order to identify whether they have contexts where they could use PBT but
currently do not. We will also ask them whether they have tried to use automated
testing tools in the past, whether they think they would use a tool like
Hypothesis for their tests, and ask for their opinions about perceived value of
the tools and barriers. Taken together with this prior survey, these two surveys
will produce an account of barriers to PBT use among active users, and for those
who, whether by choice or happenstance, do not currently use them.
...
To arrive at designs better suited to real-world PBT, we will conduct
...
Each observation study will be relatively small in
size---designed to answer design questions for just one of the proposed tools,
