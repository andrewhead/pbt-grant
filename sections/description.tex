...
we can recruit a lot more than 100...)}
...
\publicationtarget{the International Conference on Software Engineering (ICSE)}
\bcp{How about
  \begin{itemize}
...
\publicationtarget{the PLATEAU Workshop}
...
\publicationtarget{the Symposium on the Foundations of Software Engineering
(FSE) and in an article for the Communications of the Association for Computing
Machinery (CACM)}
...
gives confidence that it holds---provided the inputs are ``interesting enough.''
%
However,
...
exercise much of its functionality; most tests should be
...
also be used to {\em enumerate choices} or make {\em guided choices}.
...
\publicationtarget{the International Conference on Functional Programming (ICFP)}
...
\publicationtarget{the conference on Programming Language Design and Implementation (PLDI)}
...
\publicationtarget{the workshop on Human Aspects of Types and Reasoning Assistants (HATRA)}
...
}\hg{I put a note about this in the orientation. Is that enough? I took a look
and didn't see any good places to change language in this section.}
%
...
\publicationtarget{the conference on Object Oriented Programming, Systems, Languages, and Applications (OOPSLA)}
...
\publicationtarget{the symposium on User Interface and Software Technology (UIST)}
...
\publicationtarget{the symposium on Trends in Functional Programming (TFP)}
