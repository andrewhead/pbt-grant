...
intuitive. We plan to extend prior work exploring how to implement
data structures like monads in imperative
...
Python, Java, and Rust.\amh{If this prior work seems really strong, we should
mention this. My gut instinct would be to believe that implementations of monads
in imperative languages is hacky and reliable and therefore shaky grounds for
a one-year project that depends on it, but I might be wrong, though maybe
reviewers would have the same bias.}\bcp{@Harry, thoughts?}
...
\publicationtargets{International Conference on Functional Programming (ICFP) and
User Interface Software and Technology (UIST) \amh{Can we change to just ICFP?
There might be a UIST project in the language design, though I'm not sure it is
emphasized enough here, and I think that would make this project 2 years of work
instead of 1.}}
...
realistic logs of input data, where each log entry includes a timestamp
and an event type.
%
...
understanding distributions of complex input data. Success of this (and the
...
cross-platform, language-agnostic\amh{maybe cut cross-platform and
language-agnostic---we don't talk about that anywhere and it sounds like a lot
of work}, open-source project (\sectionref{sec:ide}), educating
