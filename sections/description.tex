...
bring the power of both PL and HCI techniques to bear: our work will form
blueprint for the future of PBT theory and practice. After an orientation to
PBT and discussion of our motivating study, we discuss the following lines of
work:
\begin{itemize}[noitemsep]
  \item We will explore gaps in our understanding of the challenges PBT faces in
  ...
  algorithms for many PBT tasks (\sectionref{sec:gen}).
  ...
  \item We will create comprehensive resources for educating developers and
  university students in best practices for PBT (\sectionref{sec:ed}).
\end{itemize}
We conclude with a concrete outline of our work plan
(\sectionref{sec:plan-of-work}) and an account of the broader impacts of this
