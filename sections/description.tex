...
Tanimoto's work. There are examples of live environments for
functional programming like the Hazel editor and Light
Table. OmniCode visualizes the distributions of values that
