...
and IOG
\proposecut{(which
runs the Cardano blockchain and the Ada cryptocurrency)}\hg{Blockchain and
cryptocurrency aren't nearly as impressive as they were the first time we wrote
this}.
...
articulating why now is the right time for this work}
...
in PBT. Observation studies will be conducted any time\hg{Any time?} we have a need to
...
So, prior to building any\hg{Again, any? I feel like we need to soften this} tool that has a sufficiently broad design space (i.e., an
...
\publicationtarget{OCaml Workshop and/or PyCon US}
