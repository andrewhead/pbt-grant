...
We next describe the essence of the PBT approach, highlighting the
tools involved. These form the surface area of technologies that
the research community has leverage in improving.\bcp{Well, we also
  have leverage in education...}
...
\end{lstlisting}
Like most properties\bcp{?}, this one is a simple function which takes in generated
...
The value of properties arises in part from their brevity\bcp{well,
  this depends on what you count as ``the property''}: they often require
...
a bug may be triggered by some particular sequence of API calls in a
particular order,
regardless of whether they are
interleaved with other API calls. The upshot is that testing with large random
