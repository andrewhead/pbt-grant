...
generated via meta-programming and rendered for the user. When the input size is
the main barrier to understandability, we can take a more programmatic approach:
provide the user with the values represented as JSON objects, and provide them
with ways to manipulate those objects {\em in situ}.\hg{Did I use that right?}
...
Once we are happy with the design, we will publish the tool as an official
extension and publicize it to the testing community.
