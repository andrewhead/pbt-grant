...
that we will develop later in the proposal.}

\smallskip

{\bf Status.} We began thinking about reflective generators during an
earlier NSF project (described in \sectionref{sec:prior}), built a
...
while our exploratory performance measurements look promising, more
...
\amh{I am not sure I understand this last sentence.}

In order to establish reflective shrinkers as a once-and-for-all\amh{this feels 
too strong; it implies to me there won't be better solutions later} solution to
validity preserving shrinking, we plan to formalize and prove the several 
important
...
We mentioned in the motivation section that developers think of
...
software (if any) we think we will develop in these projects.}
...
concrete statement of the goal before talking about prior work?}
