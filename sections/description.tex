...
\newcommand{\efftheme}[1]{{\color{nord-purple} \em #1}}
...
{\bf Evaluation.}
\todo{
		About how developers get inputs to test with…
			Derived Generators
      Bespoke Generators
			Shrinking
		And about how developers understand testing effectiveness…
			Budgeting Time for PBT
...
appear in \sectionref{sec:motivation}.\amh{Is there anything else we want to
