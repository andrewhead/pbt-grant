...
\SUBSECTION{Generalizing the Jane Street
  Findings}{sec:survey}{1}{4}{HCI Theory}{PhD 2}{}
%
...
principles. This will probably\hg{Blah} involve identifying a subset of
...
\hg{I don't mind, as long as it doesn't make PhD 1 feel thin}
\hg{Also, BCP can you read the future work of the reflective paper at some
point and let me know if you think the synthesis angle belongs here somewhere?}%
...
\SUBSECTION{Reflective Fuzzers}{sec:fuzzing}{2}{3}{PL Practice}{PhD 1}{Engineer}
...
\SUBSECTION{Making Reflectives Usable}{sec:genlang}{4}{4}{HCI
  Practice}{PhD 1}{PhD 3}
...
\SUBSECTION{Rethinking Generator DSLs}{sec:genlang}{2}{4}{HCI Theory}{PhD
  2}{PhD 3}

\todo{Write me Andrew / Harry}

\hg{I don't know where this fits relative to everything else. I was imagining
this as a bit of a broader project asking about PBT frameworks in general (not
just generator languages)}
...
\SUBSECTION{Counterexamples as Regression
  Tests}{sec:counter}{2}{2}{HCI Practice}{PhD 3}{}
...
\SUBSECTION{Interactive Shrinking and
  Debugging}{sec:failures}{3}{4}{HCI Practice}{PhD 3}{}
%
...
\SUBSECTION{Dashboards for CI/CD}{sec:dashboards}{4}{5}{Tech Transfer}{PhD 3}{Engineer}
...
\SUBSECTION{A Minimal Implementation of
  PBT}{sec:refkey}{3}{4}{Tech Transfer}{Engineer}{PhD 1}

\SUBSECTION{Reflection in the Wild}{sec:reflpython}{2}{3}{PL Practice}{????}{????}

\bcp{We can mention Python if needed, but let's try to keep our aims a
bit broader than just Python.}

\bcp{Who should do it?}

\SUBSECTION{Nurturing the PBT
  Ecosystem}{sec:reflpython}{2}{3}{Tech Transfer}{Engineer}{PhD 2}

\SUBSECTION{IDE Integrations}{sec:ide}{3}{5}{Tech
  Transfer}{Engineer}{PhD 3}

Alternative title: [NAME]: An Editor Extension for PBT

(Make sure this doesn't overlap things we've already said.)

\hg{It feels like putting this in Diffusion undersells it. We want everything we
build to be integrated into a PBT IDE in a way that users can easily find and
work with. Is there a way we can get an IDE project into the Specification
section so we can connect back to these sections later?}

\SUBSECTION{Extensible Tools}{sec:extensibility}{3}{5}{Tech Transfer}{Engineer}{PhD 3}
...
\SUBSECTION{Interactive Property
  Specification}{sec:interactive}{3}{4}{HCI Practice}{PhD 4}{Engineer}
...
\SUBSECTION{PBT for Undergraduates}{sec:1210}{1}{5}{Education}{PhD 4}{Engineer}
%
