...
While this is enough to indicate the upside of many kinds of improvements
to PBT, there is considerable value to be had in completing the story with
the broader population of developers.
We will therefore conduct two surveys with the goal of validating and
extending our inventory of opportunities found in our first study.
...
The first survey
aims to expand the findings of our prior interview study so that
they generalize broadly across software development settings.
We will
...
numerous recent papers~\cite{ref:bubeck2023sparks,ref:savelka2023thrilled}\amh{Citations are actually for GPT-4---update. And they are also just papers and not blog posts} has shown its potential to turn
