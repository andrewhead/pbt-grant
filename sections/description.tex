...
\proposecut{Integration testing tools get around these issues by
...
ability to test complex properties that concern internal values and
invariants.}
...
to log all updates to it.\bcp{Can OCaml actually do that??}
...
``mere matter
of engineering,''\bcp{how hard is it?} but the language for properties
is an exciting\bcp{have you noticed I always cut this word when I see
  it?  :-)} opportunity to
...
\SUBSECTION{Proposed Work: Automating Model-Based PBT}{sec:automating}{2}{3}
...
process.  \bcp{But now that they're done, why is more research needed?}
...
\SUBSECTION{Proposed Work: Interactive Property Specification}{sec:interactive}{2}{3}
...
\proposecut{Before presenting our proposed work to improve the state
  of random data generators, we must first discuss the major
  difficulties with random generation for PBT and the existing work
  that aims to address those difficulties.}  \todo{Link all of this to
  the intro}
...
\bcp{Maybe this is also better described as proposed work?}
...
\SUBSECTION{Proposed Work: Reflective Shrinking}{sec:shrinking}{3}{4}
...
% \gantttitle{Ongoing}{1}
  ...
  \gantttitle{Year 4}{1}
  \input{main.workplan}
% \ganttsection{Foundation: Understanding Needs and Opportunities (1 pages)}
% \task{Surveys to Generalize Findings}{sec:survey}{1}{1} \\
% \task{Observations of PBT in Practice}{sec:observations}{2}{2} \\
% \ganttsection{Specification: Widening the On-Ramp (2 pages)}
% \task{When to Specify It!}{sec:whento}{3}{4} \\
% \ganttsection{Proposed Work: Writing Properties Over Output Logs}
% \task{Proposed Work: Automating Model-Based PBT}{sec:automating}{2}{3} \\
% \task{Proposed Work: Interactive Property Specification}{sec:interactive}{2}{3} \\
% \ganttsection{Generation: Better Tools for Random Inputs (3 pages)}
% \task{Reflective Generators}{sec:reflective}{1}{2} \\
% \task{Bringing Fuzzing into Focus}{sec:fuzzing}{2}{3} \\
% \task{Proposed Work: Reflective Shrinking}{sec:shrinking}{3}{4} \\
% \task{Empirically Evaluating PBT Tools}{sec:benchmarking}{1}{3} \\
% \ganttsection{Validation: Understanding Testing Effectiveness (3 pages)}
% \task{Understanding Failures}{sec:failures}{3}{4} \\
% \task{Evaluating Input Distributions}{sec:evaluating_distributions}{3}{4} \\
% \task{Tuning Input Data Distributions}{sec:tuning}{1}{3} \\
% \task{Assessing Testing Effectiveness}{sec:assessing}{2}{4} \\
% \task{Proposed Work: Transforming Counterexamples into Regression Tests}{sec:counter}{3}{4} \\
% \task{Running More Tests with Less Work}{sec:more}{3}{4} \\
  % \task{Jane Street study (analysis and
  %   publication)\iflater\bcp{?}\fi}{sec:motivation}{1}{2}
%  \task{Surveys to Generalize Findings}{sec:survey}{1}{1}
%  \task{Observations of PBT in Practice}{sec:observations}{2}{2}
  % \ganttsection{Specification}
  % \ganttsection{Generation}
  % \ganttsection{Validation}
  % \ganttsection{Education}
\end{ganttchart}
  \caption{Plan of work.}\label{fig:workplan}
\end{figure}
