...
\SUBSECTION{Tyche: Visualizing and Tuning Data Distributions}{sec:evaluating_distributions}{2}{3}{HCI
...
\subsectionstar{Accelerating understanding of input distributions}{}{}
...
serious open-source effort.} \amh{Good thinking. I moved the stuff about \tyche{} up into Section 6. We can remove this and replace it with the mentioned plans of collaboration. Love the idea of mentioning the AWS collaboration!}
 The IDE will be developed in consultation with
