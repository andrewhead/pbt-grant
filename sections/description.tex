...
prematurely converging on reflective generators.}
...
generators (\sectionref{sec:reflectivepeople}) \amh{I think this is out of date}. Finally, we discuss metrics
...
and by top-tier publications \amh{ours or others'?}, including performance evaluations and/or
user studies as appropriate.
PI Pierce is a longtime collaborator of John Hughes \amh{I'm not sure there's
enough context here to make this name-dropping make sense}, one of the
...
gives confidence that it holds \amh{complex sentence}---provided the inputs actually
...
Approaches\amh{Solutions?} to these challenges
...
We can further improve monadic generators by re-framing them as {\em
  parsers of random choices}. \amh{What is the degree of potential improvement?
  Is this small potatoes or big potatoes?} The usual intuition is that a generator
...
reflective generators won a distinguished paper award at ICFP 2023. \amh{Ref?}

The definint attribute of\amh{I rewrote the last phrase, check} reflective generators is that they can be run
{\em backward}.
...
that of normal monadic generators\amh{which is good, usable syntax?}.
