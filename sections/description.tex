...
Much of this work could be automated away. After all, a counterexample
is just an input to some component plus (as specified in the property) 
the expected output that, at the moment, the component is failing to
produce.\bcp{There's a problem here, I think (as I'm realizing while
  trying to untangle the wording): How do we know the expected output?}
In theory, a PBT counterexample could be transformed into a
3-statement unit test. 
