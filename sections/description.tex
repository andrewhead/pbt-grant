...
\begin{itemize}[noitemsep]
  ...
  \bcp{??}\hg{Tools for automating MBT and testing based on logged output?}
  ...
  either of these, but I think what I had wasn't totally unreasonable...}
...
would lead to an invalid value.} Figure~\sectionref{fig:mutation} shows the way this
