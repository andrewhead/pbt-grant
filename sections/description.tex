...
\SIMPLESECTION{Motivation: Formative Studies of PBT in Industry}{sec:motivation}
%
...
interactive tools
(\sectionref{sec:observations}); finally, we will distill study findings
into a cognitive
...
\bcplater{The specifics of the theory that we sketched seem too
