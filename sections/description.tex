...
ChatGhostwriter}{sec:ghostwriter}{3}{3}{HCI Practice}{PhD 2}{PhD 4}{Head}

\begin{wrapfigure}{r}{.4\textwidth}
  \includegraphics[width=.4\textwidth]{assets/chatghostwriter.pdf}
  \caption{A mock-up of an interaction with ChatGhostwriter.}
\end{wrapfigure}
...
Our re-imagining of Ghostwriter, dubbed {\em ChatGhostwriter}, will be a chat
...
ChatGhostwriter will be able to pull from all of the current Ghostwriter
