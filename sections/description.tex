...
functions versus via DSLs, or the use of annotations to steer
generation\bcp{Don't think I've seen annotations used to steer
  generation...?}), and perform a small number of comparative studies to gain
