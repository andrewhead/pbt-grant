...
for growth. The 500K estimate for
Hypothesis users is only 3\% of total Python developers~\cn{}; by comparison,
a 2020 estimate from JetBrains~\cite{noauthor_java_nodate} estimates that JUnit,
the most popular unit testing library in Java, is used by over 60\% of Java developers!
And the list of
companies using PBT, while substantial, is very far from whole of the software
industry.
This gap represents an gigantic opportunity to increase software quality
...
two workshop presentations~\cite{goldstein_problems_2022,shi_towards_2023} and to the ongoing
...
Regarding shrinking, the shrinking algorithm provided by Hypothesis is powerful, but
perhaps not optimal. Hypothesis shrinkers reduce the input randomness to the
...
related to the size of the shrunken inputs. Ideally, we want reflective
shrinkers to {\em always} produce smaller inputs, which requires a stronger
statement about the construction of the generator that is theoretically more
involved.
