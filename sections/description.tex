...
\todo{Harry will compress / reorganize this part. }
...
We began thinking about the basic concept during a past NSF
project (see \sectionref{sec:prior}), and we will
submit a first paper to ICFP 2023.
...
\bcp{Some of this turns into background material; much will be
  commented out.}
...
\SUBSECTION{Reflective generators}{sec:reflectivefuzzing}{2}{2}{PBT
  Theory}{PhD 2}{Engineer}{Pierce}

\todo{Compress!  And remove the proposed PLDI submission.}
...
\SUBSECTION{Reflective generators for the people!}{sec:reflectiveusable}{3}{3}{HCI
  Practice}{PhD 2}{PhD 4}{Pierce}
\todo{Could we reorganize so that something more compelling appears as
our first technical contribution?  Maybe talk about getting
reflectives into Python?}
...
\SUBSECTION{Generator automation (cut?!)}{sec:genauto}{4}{5}{PL Theory}{PhD 2}{REPL 4}{Pierce}
%
