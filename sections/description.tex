...
The example-based tuning approach we described in the first reflective
generators paper faithfully follows the tuning procedure used by
existing algorithms, which was important for demonstrating the
flexibility of reflective generators, but we do not claim that that
algorithm is the best way to tune a generator.
