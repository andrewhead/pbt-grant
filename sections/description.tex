...
(\sectionref{sec:diffusion}).  \bcp{mention other diffusion tasks}
% \end{enumerate*}
% \end{itemize}
\end{enumerate}
...
process\proposecut{, as well as to formally validate these tools}. \bcp{That
...
\discuss{Uh oh -- if we delete the Education section, what becomes of
  these?  Can we rename them Diffusion??}
