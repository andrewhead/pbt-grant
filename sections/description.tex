...
\SUBSECTION{Reflective Shrinkers}{sec:shrinking}{2}{3}{Harry}
...
\SUBSECTION{When to Specify It!}{sec:whento}{1}{3}{Harry}
%
PBT is often described as a kind of lightweight formal method.   One
...
\SUBSECTION{Interactive Property Specification}{sec:interactive}{1}{2}{Other}
