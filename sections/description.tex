...
%
\writeme{(Also)} In an ongoing study of users of OCaml's QuickCheck testing tool
at Jane Street Capital, a Wall Street financial firm, we have heard
strong enthusiasm \writeme{details...}.
...
\writeme{(However, what the world has right now is decent bare-bones tools,
...
%
\writeme{... describe contributions}
...
\iflater\bcp{Dark mode will not come out well if people print out the
  proposal...}\fi
\end{wrapfigure}
