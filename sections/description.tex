...
The scale of this project is essential to its success.
\todo{Why?
  \begin{itemize}
  \item Engineer needed to support the research efforts and---even
  more importantly---to push things out into industry by integrating
  research results into existing industrial PBT tools like Hypothesis
  and building a production-quality programming environment with
  integrated PBT visualization tools.
  \item Four students...
  \end{itemize}
  }
...
well-liked, but they are
inconsistent and under-maintained. We plan to provide
\edutheme{Support and Guidance for Open-Source Communities} that will help our
...
\SUBSECTION{Generator automation}{sec:genauto}{4}{5}{PL Theory}{PhD 2}{}{Who?}
%
...
\SUBSECTION{Counterexamples as regression
  tests}{sec:counter}{5}{5}{HCI/PL Practice}{PhD 3}{}{Who?}
%
...
\SUBSECTION{Tyche: An IDE for PBT}{sec:ide}{2}{5}{Tech Transfer}{PhD 3}{Engineer}{Who?}
