...
in this way, can be interpreted equivalently as a standard monadic generator or
as a source of random choice strings and a parser over those strings. See the
paper for more details on the free generator representation and for our proofs.}
