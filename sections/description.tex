...
split roughly into two thrusts, one focused on PL techniques and the other on
HCI, but all projects will include ideas from both areas.

The PL thrust, led by PhD candidate Harrison Goldstein, will take place from
years 1--3 

In year one, Harrison Goldstein, a current PhD student, will continue his work
on reflective generators and begin work on {\em When to Specify It!}. At the
same time, PI Pierce and PI Head will work with Harrison to advise an
undergraduate or masters project to begin work on a language properties over
logs. In year two, we will hire a new PhD student, Student 2, to begin work on
surveys to generalize the Jane Street findings and begin work on a tool to
evaluate data distributions. Harrison, in the meantime, will finish the
reflective generators work and {\em When to Specify It!} and begin exploring
reflective shrinkers and fuzzers.  As the properties for logs work comes to a
close, we will take on an undergraduate or masters student in HCI to begin work
on turning counterexamples into regression tests.

to begin implementing a PBT
