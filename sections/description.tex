...
\publicationtarget{Trends in Functional Programming (TFP) \bcp{Why
    TFP?  And more generally: I feel like for 7.1 to 7.4 we could
    just say at the top of the section that we have budgeted for
    several trips to speak at developer conferences to disseminate
    these tools, educational materials, and ideas.}}
...
structures a powerful anchor for demonstrating the power of PBT. Building on
recent PBT teaching in data structures
courses~\cite{wrenn2021using,nelson2021automated}, we will integrate PBT into
Penn's CIS 1210 course on data structures (which PI Pierce regularly teaches). We
will evolve the curriculum to emphasize themes in PBT that have arisen from our
formative research, to help students identify good circumstances for
...
Broad impact is key to our research agenda, and many of the specific
