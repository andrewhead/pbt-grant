...
the prior work on a larger class of generators.
...
example, shrink inputs provided by the user or from a bug report, which is
incredibly helpful for debugging and would previously have required tedious
manual shrinker development.
...
iteration in our current paper may give users too much power, potentially hurting
usability (see
\sectionref{sec:reflectiveusable}), but limiting that power may have important technical
...
Reflective generators are a compelling foundation for a new generation of
