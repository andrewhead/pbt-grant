...
\SUBSECTION{Generalizability of the Jane Street findings}%
   {sec:survey}{1}{2}{HCI Theory}{PhD 1}{UGrad/MS 1}{Head}
%
...
Theory}{PhD 2}{UGrad/MS 3}{Pierce}
...
\SUBSECTION{Generator automation}{sec:genauto}{4}{5}{PL Theory}{PhD 2}{UGrad/MS 4}{Pierce}
%
...
\SUBSECTION{Properties over program traces}{sec:outpurprop}{2}{3}{PL
  Practice}{PhD 3}{UGrad/MS 5}{Pierce}
...
\SUBSECTION{Model-based properties for
  modules}{sec:automating}{3}{4}{PL Practice}{PhD 3}{UGrad/MS 6}{Pierce}
...
\SUBSECTION{Automatic explanations for properties}{sec:understanding}{4}{5}{HCI
  Theory}{PhD 3}{UGrad/MS 7}{Pierce}
...
\hg{Is the next paragraph not doing a good enough job here? We could move it up maybe?}
...
\SUBSECTION{Evaluating data
  ...
  Practice}{PhD 4}{UGrad/MS 8}{Head}
%
...
\SUBSECTION{Tuning data distributions}{sec:tuning}{3}{4}{HCI
  Practice}{PhD 4}{UGrad/MS 9}{Head}
%
...
\SUBSECTION{Counterexamples as regression
  tests}{sec:counter}{5}{5}{HCI/PL Practice}{PhD 4}{UGrad/MS 10}{Head}
%
...
also plan to work with undergraduate and masters\bcp{Our work plan is
  ...
  the REPL students?  How many students total?}
  \hg{I added a bunch more undergrads to the work plan; what else do we have to
  say here?}
...
developers and user communities of other popular PBT tools in languages like
Java, Rust, and Scala.
