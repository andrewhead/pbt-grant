...
\todo{GPG: The proposal must explicitly identify the participating
  ...
  programs.} \bcp{Not exactly sure where/how to do this...?}
...
Addressing these usability challenges will require insights from both the
...
process, as well as to formally validate these tools.

The rest of the proposal is structured as follows.  Sections
...
\sectionref{sec:education} then outline our plans in each of the
themes listed above.  The Project Description concludes with a
discussion of the broader impacts of the proposed work
(\sectionref{sec:broader-impacts}) and the results of our prior
NSF-supported work (\sectionref{sec:prior}).
