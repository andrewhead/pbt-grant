...
Building on the free generator work described above, we have begun looking at
...
\begin{figure}[h]
  ...
  BST invariant. \amh{Can we add a brief description of the mutation that is
being performed on this tree? To me, the intention behind the change is not
obvious. Which of the changes are performed by the ``programmer'', and which are
automatically propagated?}}\label{fig:mutation}
\end{figure}
...
experimentation will be required. \amh{Is there a way to make this status report
make the success of this project sound more assured (if we think it is)? Some of
the later projects in the proposal depend at least in part on this working.}
