...
Given a property, the PBT tool generates a large number of inputs and
...
inputs are tried, the user gains confidence that the property holds in
general.

Our focus in this project is on {\em random}
...
interleaved with other API calls.  Thius means that testing with one
...
\bcp{This is also the place to make our strongest argument for
  ...
  of application (in some common cases), ... what else?}
