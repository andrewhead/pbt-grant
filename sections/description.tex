...
WTSI and HTSI...}\bcp{The distinction is already muddy!}
...
choice because you already had to write down the spec for something
else}\bcp{But how often does this actually happen, in an industrial
context?  Seems more distracting than helpful.}
...
confusing readers.} and a great opportunity for new
...
ref:le2018deep, ref:claessen2010quickspec}\bcp{There must be more work on automatically generating
...
evaluated in terms of their {\em ability} rather than their {\em
  usability}---\bcp{needs a gloss explaining what we
  meant by that}.
