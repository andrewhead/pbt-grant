...
the tools built on them in \sectionref{sec:spec} and \sectionref{sec:diffusion}
and by top-tier publications (including performance evaluations where appropriate).
