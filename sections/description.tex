...
year~\cite{Pierce:Yow22}.  \bcplater{How many respondants are we
  aiming for??}
...
\SUBSECTION{PBT interaction models}{sec:observations}{4}{5}{HCI
   Theory}{PhD 1}{}{Head}
%
Our higher-level studies will also not\bcplater{Why not??} answer
granular questions that might
inform more traditional programming tool design\bcplater{more
  traditional than what??}, for example:
(1) How much time
...
\sectionref{sec:val}), we will observe developers working on PBT tasks. These
