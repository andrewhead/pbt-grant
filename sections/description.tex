...
challenging new research questions: participants discussed usability challenges
that demand
advances in technical foundations and
tool design.\bcp{Last sentence weak.}\hg{Any better?}
...
will be used to develop \rewrite{powerful domain-specific languages and type-based automation
to improve the PBT process}\hg{Better?}, and to formally validate these
...
specification, as in an RFC or other formal document'' and then drop the
QuickChick reference?} Finally, the
...
of things more clear, but I agree they're still not obvious}
\begin{lstlisting}
...
(advised by PI Pierce, highlighted in blue) and HCI methods and tools (advised
