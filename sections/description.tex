...
\SUBSECTION{Automating High-Leverage Scenarios: Ghostwriter++}{sec:ghostwriter}{4}{4}{HCI Practice}{PhD 3}{PhD 4}{Head}

\hg{TODO: I still need to write this, but I think S5 is way better now}
\hg{
  Here's the outline I had in mind:
  \begin{itemize}
    \item Stuff above will be in here
