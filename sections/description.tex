...
how the design may be refined into a tool that real developers can use. Once we
are happy with the design, we will publish the tool as an official extension,
maintain it as an open source project, and publicize it to the testing community.
