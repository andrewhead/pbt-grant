...
program on
\iflater \hg{This isn't the title anymore---remove italics?} \fi
\emph{usable
...
\SUBSECTION{Usability of PBT Frameworks}{sec:frameworks}{2}{4}{HCI Theory}{PhD
1}{PhD 3}{Who?}
%
...
Of course, comparing every framework in every language to every other is
infeasible and unhelpful; instead, we will identify dimensions along which PBT
...
into automating random data generation, whereas Hedgehog in Haskell is designed
...
implement properties as basic predicates in the host language, while others have
a rich language of properties---do property languages actually make a
difference?

To facilitate answering these questions, we will design and implement a minimal,
modular PBT framework that can be tuned along the dimensions we want to study.
...
\todo{Write me someone
  \begin{itemize}
    \item All of the things in this section work best in someone's editor
    \item We want to make Tyche, an IDE for PBT, that incorporates these and
    more ideas
  \end{itemize}
}

\hg{Name is a placeholder. Tyche is a god of randomness, and I've been
  waiting to use the name forever, but I'm not even a little attached
  to it} \bcp{I like it!  Probably worth a web search to make sure
  nobody (in this domain) has snapped it up.}
...
\SUBSECTION{Going Beyond Research Software}{sec:engineersupport}{2}{3}{Tech
