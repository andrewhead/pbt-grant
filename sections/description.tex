...
users~\cite{ZacPersonalCommunication}\iflater\bcp{Am I remembering that
  right?}\fi---creating large benefits in productivity and software
...
\hg{Then why are we asking for \$600k+? :-)} \bcp{We're asking for
  \$1.2m, but even that is not much in the grand scheme...}
