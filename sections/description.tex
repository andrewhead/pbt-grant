...
%   believe}
%
\item We will design novel tools for \thread{interacting} with properties
...
Any need-finding study is necessarily limited to the settings in which it is
studied. Our choice of Jane Street as a partner was motivated by our desire to
understand PBT in its deepest usage.
At Jane Street, PBT is a
widely-adopted, well-established methodology, so there is a large
...
a well-engineered PBT framework. This enables a unified
ecosystem where developers have access to mature functional PBT tools,
use them in collaborative settings,
and know of language-level abstractions necessary
for advanced usage. These aspects make Jane Street an ideal place for
understanding PBT with modern sophisticated tooling
by users who have incentive to use it to its highest potential. The foundation we have begun
to build in this one interview study will be
broadened and strengthened by our research activities in
...
%
The research projects we have described thus far have the potential to
...
skill transfer difficult for users. Thus, we will allocate
