...
themes: \bcp{This already feels too detailed, and we still need to write
...
satisfying given preconditions, for test input mutation, and for example-based generator
tuning---all building
  on a novel ``reflective'' approach to generation (\sectionref{sec:gen}).
\item We will build novel tools for {\em interacting} with
  properties and generators---tools to help developers
locate the causes of test failures and understand how to improve the
distributions of randomly generated
data to be more representative and comprehensive\iflater\bcp{Blah.}\fi{}
(\sectionref{sec:val}).
...
% \end{itemize}
\end{enumerate}
Success in these efforts will require complementary tools from PL and
...
process, as well as to formally validate these tools. \bcp{That
  paragraph is weak.  Needs to be much stronger on the need for
  integration across domains, and between research and tech transfer.
  We should explicitly call out the engineer as critical to the
  project's success.}
...
The rest of this Project Description develops this research and
...
\sectionref{sec:ed} outline our plans in each of the
themes listed above.
...
\todo{A one-paragraph summary of the Coordination and Management
  appendix -- personnel, tasks, integration, etc. -- with a pointer to
  that appendix.}

\forreaders{Please take an especially critical look at the
  Coordination and Management appendix and at what we say
  about coordination and management here in the main project
  description.  NSF cares a lot about this!}

\todo{A one-paragraph summary of the BPC appendix, including the
  budget items associated with it.}
...
study~\cite{goldstein_problems_2022}, some respondants indicated just that.
...
examples.
\iflater
\bcp{Need to figure out how to
  talk about diffusion here... if it is too
  hard to motivate from the Jane Street study, we can
  acknowledge this.  Or just leave it out.  (Maybe that's the best?
  We're not trying to connect absolutely all the dots.)}
\hg{I think best to not; we can justify it in plenty of other ways}
\fi

Finally, these studies reveal a need for progress
in PBT
\edutheme{\normalfont \bf
...
\iflater\bcp{Not sure any more how I feel about the colors.  They are
  ...
  them out of the Coordination and Management figure)...}\fi
...
\SUBSECTION{Conducting a survey to generalize the Jane Street findings}%
   {sec:survey}{1}{4}{HCI Theory}{PhD 1}{}{Head}
\discuss{I'd like to make all the task titles more suggestive of the
  actual tasks...}
%
...
\SUBSECTION{Usability studies to compare PBT Frameworks}%
  {sec:frameworks}{2}{4}{HCI Theory}{PhD
1}{PhD 3}{Who?}
%
...
\SUBSECTION{Observational studies to develop process models}{sec:observations}{2}{4}{HCI
  Theory}{PhD 1}{}{Who?}
%
...
\SUBSECTION{Developing a theory of PBT}{sec:cogtheory}{3}{5}{HCI
...
\SUBSECTION{Developing tools to test properties over program traces}{sec:outpurprop}{2}{2}{PL
  Practice}{PhD 2}{UGrad/MS 1}{Who?}
...
\SUBSECTION{Developing languages to express model-based properties for modules}{sec:automating}{3}{3}{PL Practice}{PhD
2}{UGrad/MS 2}{Who?}
...
\SUBSECTION{Designing automatic explanations for properties}{sec:understanding}{2}{5}{HCI
  Theory}{PhD 4}{}{Who?}
%
\todo{Write me Andrew.
  \begin{itemize}
...
\SUBSECTION{Creating a generator benchmark suite}{sec:benchmarks}{1}{2}{Tech
  Transfer}{PhD 2}{PhD 1}{Who?}
%
\todo{(Re)write me Harry and Benjamin}
...
\SUBSECTION{Defining reflective generators}{sec:reflective}{1}{2}{PL
  Theory}{PhD 2}{}{Who?}
...
\SUBSECTION{Evaluating the usabilility of reflective generators}{sec:reflectiveusable}{4}{4}{HCI
...
\SUBSECTION{Improving languages for generator automation}{sec:genauto}{4}{4}{PL Theory}{PhD 2}{}{Who?}
%
\todo{Write me someone
  \begin{itemize}
    \item We want to make reflectives usable as their own language, but they're
    also useful as an intermediate language
    \item There is a lot of potential for automating the process of creating reflectives
    \item Option 1: Automate the backward annotations
    \begin{itemize}
      \item Hoogle+ / synthesis?
      \item Z3?
    \end{itemize}
    \item Option 2: Automate the whole darn thing
    \begin{itemize}
      \item Infer from the precondition code? Type system?
      \item Synthesize?
      \item ???
    \end{itemize}
  \end{itemize}
...
\todo{Tweak the title when we understand the content. :-)}
...
\SUBSECTION{Building tools for evaluating generated data
...
\SUBSECTION{Building tools for tuning data distributions}{sec:tuning}{3}{4}{HCI Practice}{PhD
3}{UGrad/MS 4}{Who?}
%
...
\SUBSECTION{Developing methods for transforming counterexamples into regression
  tests}{sec:counter}{2}{2}{HCI/PL Practice}{PhD 3}{}{Who?}
%
...
\SUBSECTION{Building tools for interactive shrinking and
...
\SUBSECTION{Designing dashboards for long-running tests}{sec:dashboards}{4}{5}{Tech Transfer}{PhD
3}{Engineer}{Who?}
%
\todo{Write me Andrew?}
...
\SUBSECTION{Designing Tyche, an IDE for PBT}{sec:ide}{3}{5}{Tech Transfer}{PhD 3}{Engineer}{Who?}
...
\SUBSECTION{Nurturing the PBT ecosystem}{sec:nurturing}{2}{3}{Tech
Transfer}{Engineer}{PhD 1}{Who?}
...
\SUBSECTION{Beyond research software}{sec:engineersupport}{2}{3}{Tech
Transfer}{Engineer}{}{Who?}

\todo{Write me someone
  \begin{itemize}
    \item The engineer will support the PhD projects with design input and
    longer-term maintenance
    \item Ultimate goal is to avoid research software that never actually makes
    it into widespread usage
  \end{itemize}
}
...
\SUBSECTION{Writing a review, ``When to Specify It!''}{sec:whento}{3}{5}{Education}{PhD
  1}{PhD 4}{Who?}
%
...
\SUBSECTION{Designing tools for interactive property
...
\SUBSECTION{Developing curriculum for PBT for undergraduates}{sec:1210}{1}{5}{Education}{PhD 4}{Engineer}{Who?}
%
...
\bcp{Needs a good paragraph about tech transfer.}

\noindent{\bf Educational Benefits.}
%
The most immediate broad impact of the proposed work will be the
development of educational materials.\bcp{Not sure that's true any
  more---we've got Diffusion now!} Educational activities will be
...
\todo{Before sending to readers, we should suppress the appendix
  sections that we don't want them to bother with.}

\forreaders{There are some separate documents beyond the bibliography
  that we'd love to hear your comments on...}
