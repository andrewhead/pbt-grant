...
\proposecut{We describe those themes below, referring informants from their study using
pseudonyms P1--30.}
...
% \hg{Maybe this should get merged into the section heading?}
\proposecut{Together, the studies described in this section provide a firm foundation many
...
\sectionref{sec:automating} we describe tools we will develop to apply PBT 
...
\amh{Provide a forward-reference to the work on ``When to Specify It!'' to 
better reflect the framing of the motivations section.}
...
interface was too complex to write straightforward properties about. \amh{System 
A and System B are a bit abstract for my liking; I am having it hard to follow 
the section without a more concrete sense of what these systems are and why they 
would interact.}

\amh{Here we should to briefly state the goal of this line of work before moving 
onto the hypothetical solution.}
