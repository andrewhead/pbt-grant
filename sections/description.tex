...
%
To set the stage, we next describe the basics of PBT\proposecut{, with
...
%
a
tool for helping students write properties
interactively (\sectionref{sec:interactive}).


\SUBSECTION{``When to Specify It!''}{sec:whento}{1}{2}{Harry}
%
Our very first pilot study with users of PBT suggested that one challenge to
using PBT is the writer's block of coming up with specifications worth testing
for one's software~\cite{ref:goldstein2022some}. Our follow-up interviews at
Jane Street showed us that the developers there had developed a tacit
understanding of ``no-brainer'' situations where PBT was an obvious choice, due
to the nature of software and the ease of specifying properties. This contrast
showed us that developers do not uniformly have a strong understanding of the
situations where PBT can and should be used. A critical role of PBT education is to
disseminate this tacit understanding of
those situations where properties should be used because they can be easily
envisioned and applied, and lead to powerful assurances about the software.

We aim to produce the authoritative resources that help developers understand
high-leverage situations to use properties. We will begin with an effort
tailored to the academic community, where we write a survey paper with the
...
review of case studies that apper in research papers and experience reports in
...
Building on the strong foundation of the survey, we will distill the findings
...
at a major professional developer talk in the functional programming community.
