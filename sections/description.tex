...
research and technology transfer agenda for this proposal.
...
comprehensive\bcp{too grand?} IDE
for PBT, dubbed \tyche.
...
\begin{wrapfigure}{r}{.63\textwidth}
  ...
  \caption{Overview of the proposed research.  \bcp{remove the icons!}}
  \label{overview}
\end{wrapfigure}
%
\bcp{cut or compress:}
...
\SUBSECTION{Reflective generators for the people}{sec:reflectivefuzzing}{2}{2}{PBT
  Theory}{PhD 2}{Engineer}{Pierce}

Ultimately, we would like reflective generators to become the de facto
representation of generators in many real PBT frameworks. In this section we
outline some important steps towards that goal.

Most saliently, it is not yet clear how reflective generators should be
