...
(\sectionref{sec:diffusion}).  \ifnext\bcp{mention other diffusion tasks}\fi
% \end{enumerate*}
% \end{itemize}
\end{enumerate}
...
\SUBSECTION{Counterexamples as regression
  tests}{sec:counter}{5}{5}{HCI/PL Practice}{PhD 4}{}{Who?}
%
...
\SUBSECTION{``When to Specify
  It!''}{sec:whento}{3}{3}{Education}{Faculty}{Everyone else}{Both}
%
