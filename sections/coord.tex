...
\underconstruction{The PIs will supervise everyone else and each other.  Say
  that in more detail.  :-)
  \begin{itemize}
  \item This project will be a main focus for both PIs during the
  whole five years.  Two summer months are allocated to each PI for
  this reason.
  \item The main synchronization mechanism will be weekly group
  meetings for the entire project team (PIs, PhD students, staff
  engineer, undergraduates and masters students).
  \item Slack and email will be used for daily team communications.
  Git will be used for software development and writing.
  \end{itemize}
}
