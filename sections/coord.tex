...
\todo{One more standard measure of success is publications.  We might
  as well talk about this.}
...
and several undergraduate interns and Master's students.  The work of
...
\underconstruction{The PIs will supervise everyone else and each other.  Say
  that in more detail.  :-)
  \begin{itemize}
  \item Complementarity of expertise.
...
\ROLE{Ph.D. 1}{Advisor PI Head}{Foundations}{The first Ph.D. student
  ...
  efforts. \todo{Explain how much work these studies are!}
}{Qualitative HCI}
...
\subsection*{Mechanics of team management}
