...
\todo{Mention Leo and Hila and Zac here.}
...
and several undergraduate interns. We will include other undergraduate and
...
generators developed by Ph.D. 2, they will introduce controls
for
programmers to influence the behavior of generators through direct
manipulation. The Ph.D.  student will also design tools that support
the
...
students. We consulted with an industry hiring manager to budget for a
...
out of college with experience with open source and variety of programming languages.
...
Finally, the
success of the more foundational threads will, as usual, be measured at least
