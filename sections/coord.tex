...
student, while PI Pierce will supervise the PL-related PhD students.
...
\ROLE{PhD 1}{Advisor  Head}{HCI (Foundations + Interaction)}{%
The first PhD student will develop foundational knowledge about the practice of PBT and incorporate it into the development of novel interactive systems for PBT. The work will begin with surveys expanding and generalizing our understanding of barriers. Then, it will proceed through the iterative design of new interfaces that provide programmers with powerful views of input distributions and controls for tuning them. These interfaces will draw on powerful theory in reflective generators that have already been developed. The student will also assist in language design efforts undertaken by PhD 2. This student's work will lead to the development of the \tyche{} IDE.
}{Qualitative HCI + HCI Systems}

\ROLE{PhD 2}{Advisor  Pierce}{PL (Generation + Specification)}{%
The second PhD student advance PL technologies for generation and specification. Their initial work will focus on refining benchmark suites and advancing techniques for reflective generation. Then, they will focus on developing more usable abstractions for reflective generators, followed by extending specification languages to support the formulation of properties across module boundaries, and the more efficient specification of model-based properties. \amh{Harry or Benjamin add something about GhostWriter here.} \amh{Update to indicate what the REPL will do. My proposed plan has the PhD student working on the projects that are meatier and likely require a lot of attention to detail.}
...
\caption{Project timeline, colored by the person responsible for
  ...
  \explaincolor{REPL (with support from PhD 2)}{\replcolor},
  ...
  We assume that PhD students 1 and 2 join the
