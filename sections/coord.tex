...
tasks requiring particular expertise in PL (advised by PI Pierce), HCI (advised 
by PI Head).
%  \todo{Describe how these are displayed
% in the table}
...
\caption{Project tasks and personnel \iflater\bcp{If we keep the Category
    ...
    categories.}\fi\bcp{Note some ???s. Drop the Category column?}
  \bcp{Check the secondary effort}}
\label{fig:roles}
\end{figure}
...
\ROLENOSKILLS{Ph.D. 1}{Advisor PI Head}{HCI Foundations}{The first Ph.D. student 
will develop foundational knowledge to support the human-centered design and 
...
formative observational studies related to tool-building efforts.}

\ROLENOSKILLS{Ph.D. 2}{Advisor PI Pierce}{PL Foundations}{The second Ph.D.  
student
...
\ROLENOSKILLS{Ph.D. 3}{Advisor PI Pierce}{PL Languages}{The third Ph.D. student 
...
\ROLENOSKILLS{Ph.D. 4}{Advisor PI Head}{HCI Systems}{The fourth Ph.D. student 
