...
\amh{
(Summary of departmental BPC plan:)
* Increase gender and racial diversity of undergraudate students, demonstrating
year-on-year improvement, via conference participation, diversity summits, and
engaging undergraduate researchers.
* Incrase gender and racial diversity of graduate students, demonstrating
year-on-year improvements towards matching and exceeding national averages,
recruiting doctoral students and hosting mentoring workshops.
* Incrase gender and racial diversity of faculty, via faculty recruitment and
seminar speakers. Head will be co-organizing the HCI seminar series in the
department, with a goal of hiring at the goal levels.
* Incrase gender and racial diversity for K--12 students, via the Fife--Penn CS
Academy, Tech It Out Filly, and AP course preparation.
}
...
students}
\subsection*{Department Goal 3: Incrase gender and racial diversity of faculty}
