...
coming months.  The following section describes specific planned
BPC-related activities for PIs Head and Pierce during the period
covered by this proposal.  Section 2 below sketches the draft
departmental plan, which the current PIs are helping shape.
...
\iflater\todo{Say which projects are particularly appropriate.  Mention that
  BCP wrote the text they will be studying from.}\fi
\end{enumerate}
