...
\amh{Thank you so much for writing all of this, Benjamin!  Overall, I like this
\emph{a lot}. If there is one change that we make the below that I think would
make this have ``met the bar'' for the panel I was on, it is if we get more
specific about intended populations (i.e., who are the ``underrepresented
students.'') I think for us, the most significant groups would be non-males (who
are underrepresented in CIS as a whole and within the PL group) and Black and
Latinx students (who according to the census page I found, each represent about
10\% of PA population). Is there a way to mention that we will take special care
to recruit from these groups for REUs and TAs? I could take a go at this if you
were on board.}

% \amh{Here is my attempt to split out the above 4 goals into 5 goals for which I
% think we can state measurable outcomes and a concrete strategy. I imagine we
...
set a goal of hiring a set of TAs with approximately the same
demographics as the students in the course---or, if anything, a larger
proportion of underrepresented groups.  We strongly believe that it is
important the success of all students, not just students from
underrepresented groups, that they see a diverse mixture of TA faces.
\amh{One of us should try to reword this last sentence.}
