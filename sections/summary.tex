...
and tuning
distributions based on examples or coverage. We will also
explore automatic generator construction
and develop benchmarks for PBT tools.
%
...
project's aims, will
%
be to support the \thread{diffusion} of PBT tools and
methodologies from academia into industry through collaboration with
industry leaders and a broad range of educational activities.
