...
The ultimate goal, to be achieved through novel research, education, publications, and open-source
tools, is to make advance the state of the art in property-based testing
and give it a 
place on every
