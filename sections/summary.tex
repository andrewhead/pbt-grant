...
at companies such as Quviq, Galois, Stripe, IOHK, and
Amazon.\ifdraft\else\footnote{\forreaders{Any other big companies?  Notable open-source
  projects?}}\fi
%
...
sometimes\iflater\bcp{could we legitimately drop ``sometimes''? the
  paragraph would read much better...}\fi{} frustrated with its {\em usability}.
%
