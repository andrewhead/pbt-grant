...
What are these challenges?\hg{I suspect this is where we'll need to come down
stronger---these don't really land as ``grand'' challenges. I think we need to
couch JS and follow-on work as only the beginning}
...
effectiveness of testing.\hg{Will need to change this sentence to include interaction}
...
To tame these usability challenges and establish PBT as a mainstream
testing method, two distinct research areas must be brought to bear.
...
of Human-Computer Interaction; its home is in CISE-IIS's
